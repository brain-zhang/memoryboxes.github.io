...
然后Alice的钱包紧接着就会联系查理说：“嘿，查理。如果你给我生成（H）的未加密值（R），那么我就同意更新我们渠道的支付分配，这样你就可以得到的就会比0.5BTC多一点，我得的比0.5少一点。”

尽管查理并不知道R，但他也会同意。之后查理便会去找鲍勃说：“嘿，鲍勃。如果你给我那个能生成H的未加密的值R，我将同意更新我们渠道的支付分配，这样你就可以得到的会比0.5BTC多一点，我得到的比0.5少一点。”因为R就是从鲍勃这里生成的，所以他肯定知道。接着他马上将R告诉查理，并更新了其渠道的支付分配。然后查理将R告诉给了Alice之后也更新他们的渠道，最后交易完成，Alice以脱链的形式付给鲍勃0.5BTC。
