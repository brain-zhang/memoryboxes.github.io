...
后来随着商品交换规模的扩大，统一的支付媒介就出现了。从最原始的贝壳，到铁器铜币，再到金银物品，形成了人们统一承认的货币媒介。实物货币如金银货币的出现极大地提升了商品交易的成功率，形成了以货币为核心和交易媒介的支付清算体系雏形，极大地推动了贸易和经济社会发展。
...
所以一般央行挑放假的日子升级系统，这个时候对公业务一般办不了，但是我们平常的刷卡消费可以正常进行。
...
我认为区块链技术诞生后，清算技术又是一个进化。这个技术的意义堪比纸币和信用货币时代的变革。

在比特币诞生之前，Ripple网络其实已经在传统清算网关的基础上，基于中心化的共识，提出了新的清算网关方案。他们的技术建设其实很有意思，也非常创新。我们打算在其它篇章来介绍。目前我们单独谈谈比特币的解决方法。
