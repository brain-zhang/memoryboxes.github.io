...
是的，有的人认为这还是太麻烦了，最好有个web界面让我把币名、初始发行量、发行人等等信息填一下，最好加上两句蛊惑人心的宣传slug，然后一键发币~~
...
光发币还不足以割韭菜，还记得我们之前的介绍blockchain的文章吗？里面提到了比特币的侧链技术，并预言基于swap (原子交易)技术的交易所终将会大放光彩；
